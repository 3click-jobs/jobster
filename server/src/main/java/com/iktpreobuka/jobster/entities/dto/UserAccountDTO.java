...
public class UserAccountDTO {
	...
	public UserAccountDTO(
			...
			@Pattern(regexp = "^(ROLE_ADMIN|ROLE_USER|ROLE_GUEST)$", message = "Role is not valid, must be ROLE_ADMIN, ROLE_TEACHER, ROLE_PARENT or ROLE_STUDENT") String accessRole,
